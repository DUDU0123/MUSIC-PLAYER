...
class ArtistSongListPage extends StatelessWidget {
  const ArtistSongListPage({super.key});
    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: SideTitleAppBarCommon(
          appBarText: "Unknown Artist",
          actions: [
            TextButton(
              onPressed: () {
                // need to send the song details list to the song edit page from here
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => const SongEditPage(pageType: PageTypeEnum.songEditPage),),);
              },
