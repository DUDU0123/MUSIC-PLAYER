      ...
      body: widget.albumSongs.isEmpty
          ...
          : ValueListenableBuilder(
              ...
              builder: (BuildContext context, List<AllMusicsModel> songs, Widget?_) {
                    final List<AllMusicsModel> albumSongs = widget.allMusicController.getSongsOfAlbum(songs, widget.albumName);
                return ListView.builder(
                  itemCount: albumSongs.length,
                  padding:
